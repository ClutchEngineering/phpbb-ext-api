...
class main_module
{
    ...
    protected function handle_settings()
    {
        if ($this->request->is_set_post('submit'))
        {
            ...
            $this->config->set('clutcheng_api_jwt_secret_key', $this->request->variable('jwt_secret_key', ''));
            $this->config->set('clutcheng_api_jwt_secret_key_set', '1');
        ...
        $this->template->assign_vars([
            ...
            'JWT_SECRET_KEY'  => $this->config['clutcheng_api_jwt_secret_key'],
            'JWT_SECRET_KEY_SET'  => $this->config['clutcheng_api_jwt_secret_key_set'],
